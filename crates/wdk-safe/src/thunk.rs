...
//! wrong ABI). The [`crate::dispatch_fn`] macro generates the boilerplate
//! correctly and routes to the appropriate [`WdmDriver`](crate::WdmDriver)
//! method.
//!
//! # ABI note
//!
...
/// dispatch thunk that bridges the raw WDM ABI to a [`crate::WdmDriver`]
/// method.
///
/// # Syntax
///
